// Plugins
require('../../components/bootstrap-timepicker/js/bootstrap-timepicker.min.js');
require('../../components/parsleyjs/parsley.js');
require('../../components/select2/select2.min.js');

// Cached variables
var $timeFields = $('#start_time', '#end_time');
var $form = $('#submission-form');
var $episodeSelect = $('#episode_number');
